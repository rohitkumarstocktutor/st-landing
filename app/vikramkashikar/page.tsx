...
import { FaPenNib, FaChartLine, FaBookOpen, FaClipboardCheck, FaCogs, FaProjectDiagram } from "react-icons/fa";
...
function Page() {
    ...
    React.useEffect(() => {
        const apiUrl = "https://script.google.com/macros/s/AKfycby-TiE4gLk4bUC-mSYaT_lDwyOU1T6JTMNw2pIeYQ59qJ2Mk0x9jk_6x47QR5ASCcdasQ/exec?q=vikramkashikar";
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            const response = await fetch(`https://connect.pabbly.com/workflow/sendwebhookdata/IjU3NjYwNTY4MDYzZjA0MzQ1MjY5NTUzNTUxMzEi_pc`, {
                method: "POST",
                ...
                <div className="w-full text-black">
                    ...
                    <div className="bg-white py-4 md:py-12 px-4 sm:px-6 lg:px-12 flex flex-col items-center space-y-2 md:space-y-10">
                        ...
                        <div className="flex flex-col md:flex-row justify-center items-center gap-10 md:gap-20 w-full py-4 md:py-12 bg-cover bg-no-repeat bg-center bg-opacity-10 bg-[url('https://img.freepik.com/free-vector/abstract-background-with-monochrome-low-poly-design_1048-14453.jpg?t=st=1744112073~exp=1744115673~hmac=7998e425d4dcf5321bb513a0a2e987b8505e748ea5cfce72c5d8b78bbd2f03f5&w=1060')]">
                            {/* Left: Vikram Kashikar Info */}
                            <div className="flex flex-col items-center">
                                <Image
                                    src="/vikram.webp"
                                    alt="Vikram Kashikar Maam"
                                    height={300}
                                    width={300}
                                ...
                                <div className="flex flex-col w-full items-center p-4 shadow-2xl rounded-2xl mt-4">
                                    <span className="text-xl md:text-2xl font-bold text-blue-500">Vikram Kashikar</span>
                                    <span className="text-sm md:text-base font-semibold">Founder, Tradzy.in</span>
                        ...
                        <div className="max-w-4xl mx-auto flex flex-col lg:flex-row items-center gap-12">
                            ...
                            <div className="flex flex-col items-center">
                                ...
                                <div className="mt-4 bg-white text-center py-3 px-6 rounded-xl shadow-md">
                                    <p className="text-[#1D4ED8] font-bold text-lg">Vikram Kashikar</p>
                                    <p className="text-gray-700 text-sm">CA, Company Secretary (AIR-1)</p>
                                </div>
                            </div>
                            ...
                            <div className="flex-1">
                                ...
                                <div className="space-y-6 text-sm md:text-base">
                                    <div>
                                        <h3 className="font-semibold text-lg mb-2">Meet Vikram Kashikar</h3>
                                        <ul className="list-disc ml-6 space-y-1">
                                            <li>CA, Company Secretary (AIR-1)</li>
                                            <li>Founder, Tradzy.in</li>
                                            <li>Partner, Algoplex Trading Solutions LLP</li>
                                            <li>
                                                Ex-ICICI Direct, Kotak Securities
                                            </li>
                                            <li>10+ Years of experience</li>
                                            <li>Ex Trinity Capital (Algo division)</li>
                                            <li>Company Secretary (AIR-1)</li>
                                            <li>Handling 2 cr+ AUM</li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
