...
function Page() {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        if (hostname.includes("chahataggrawal.in")) {
            redirectUrl = "https://stocktutor.chahataggrawal.in/vaibhav-batra-algo/thankyou";
        } else {
            redirectUrl = "https://stocktutor.co/vaibhav-batra-algo/thankyou";
        }
        ...
        <>
            ...
            <noscript>
                <img
                    ...
                    width="1"
                    style={{ display: 'none' }}
                    src="https://www.facebook.com/tr?id=2043591536397129&ev=PageView&noscript=1"
                />
            </noscript>
            <Script
