...
function Page() {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        if (hostname.includes("chahataggrawal.in")) {
            redirectUrl = "https://stocktutor.chahataggrawal.in/annie-algo-trading/thankyou";
        } else {
